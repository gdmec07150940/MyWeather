...
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>> {
    ...
    private static String key="&key=5ce77d65270dc0e296e97e9ebee26672";
    ...
    protected void onPostExecute(List<Map<String, Object>> result) {
        ...
        if (result.size()>0){
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(context,result,
                    ...
                    "temperature","weather","date","week","weather_icon","wind"},new int[]{
                    R.id.temperature,R.id.weather,R.id.date,R.id.week,R.id.weather_icon,R.id.wind
            });
