package com.example.cmpunk.myweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initChooseDoalog() {
        ...
        ArrayAdapter<String> provinceAdapter = new ArrayAdapter<String>(this,
                R.layout.simple_list_item,new ArrayList<>(cityMap.keySet()));
        province_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> cityAdapter = new ArrayAdapter<String>(seft,R.layout.simple_list_item,
    ...
    private void initProbinces() {
        AssetManager assetMaanager =getAssets();
        SaxHandler handler =new SaxHandler();
        InputStream inputStream =null;
        try {
            inputStream = assetMaanager.open("City.xml");
